...
#** This mask will be used later to mark the geometries for the floor collisions. Since we got just one INTO collision mesh (the floor collider - see below) there was no need of it but in a real application with different kind of collision geometries that would be essential. You'll got this better in the upcoming step8.py using walls pushers
...
terrain = loader.loadModel("step7-8")
