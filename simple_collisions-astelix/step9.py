...
snipstuff.info.append("Try to put the avatar over a diveboard and then make it fall down to see what happen\n\nwasd=move the avatar around\nSPACE=avatar hiccup\n1-2-3=avatar over diveboard")
snipstuff.info_show()

#=========================================================================
# Main
"""
Starting off step8, this time we just change the floor collider using a better one: CollisionHandlerGravity. This will provide us a better collision simulation than the former and adds some other goods we'll see how to make good use. Note that since it gives us a fine tuning over the floor simulation it is a handler useful when applied to just one single object, we'll see why later.
"""
#=========================================================================
...
#avatarSensor.show()
# no great news here - peek an eye into step3 if sound new to you
...
terrain = loader.loadModel("step9")
