...
Beside we got a more complex setup that doubles the element involved, it follow the same principles as for step3.py plus the addition of masking as seen in step2.

NOTE If you won't find here some line of code explained, probably you missed it in the previous step - if you won't find there though, or still isn't clear for you, browse here http://www.panda3d.org/phpbb2/viewtopic.php?t=7918 and post your issue to the thread.
"""
...
snipstuff.info.append("LMB+move=move the balls")
snipstuff.info_message("Keep left mouse button down and move the move the balls trying to reach different hearts")
snipstuff.info_show()
...
brkheartModel = loader.loadModel('broken_heart')
