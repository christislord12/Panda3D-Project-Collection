...
# Main
"""
Starting from step7, we just put an additional collision handler to take care to keep the avatar grounded. This will PUSH the avatar back as soon as hit geometry we settled to be a wall: in blender we modelled polygons to wrap around the little house and all around the terrain area so that this time the avatar, differently from step7, won't pass through the house and won't be able to leave the terrain perimeter anymore. I suggest you to open the blender source to find out what I'm talking about here.
"""
#=========================================================================

#** Collision system ignition
base.cTrav=CollisionTraverser()
# did you saw this stuff in step7?
...
#** as said in step7 we tells to our collision handlers who take part to the respective tasks: for the floor the avatar ray and the avatar nodepath...
...
def avatarwalk(dt, vel):
  if vel[1]: avatar.setP(avatar.getP()+(12*dt/-vel[1]))
  if vel[0]: avatar.setR(avatar.getR()+(12*dt/vel[0]))
